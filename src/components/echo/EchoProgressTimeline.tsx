...
function EchoProgressTimeline({ startDate, endDate, progress, participants, status = "ongoing", isPrivate = false }: EchoProgressTimelineProps) {
...
export default memo(EchoProgressTimeline);
